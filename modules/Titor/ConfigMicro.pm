...
#     my $cfg = Titor::ConfigMicro -> new('foo.cfg');
#
...
# Create a new Titor::ConfigMicro object. This creates an object that provides functions
...
# @return A new Titor::ConfigMicro object, or undef if a problem occured.
sub new {
    my $invocant = shift;
